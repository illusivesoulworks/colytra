...
public class ElytraAttachmentRecipe extends CustomRecipe {
  ...
  public static final SimpleRecipeSerializer<ElytraAttachmentRecipe> CRAFTING_ATTACH_ELYTRA = new SimpleRecipeSerializer<>(
  ...
  private static boolean isValid(ItemStack stack) {
    ...
    return isBlacklist != permissionList.contains(stack.getItem())
        && Mob.getEquipmentSlotForItem(stack) == EquipmentSlot.CHEST && !(stack
